define('A:widget/pages/main/teach/story/story.async', function(require, exports, module) {

  return ['$rootScope', '$scope', 'webservice', 'globals', function ($rootScope, $scope, webservice, globals) {
  
  	$rootScope.pageTitle = '大家一起讲寓言故事';
    ...
    $scope.failing = false;
    $scope.empty = false;
  	webservice.getStoryList(limit, $scope.offset).then(function (res) {
  		$scope.loading = false;
