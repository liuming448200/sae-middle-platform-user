define('A:widget/pages/main/user/user.async', function(require, exports, module) {
  ...
  return ['$rootScope', '$scope', '$state', 'webservice', 'globals', 
    ...
    var defaultUserInfo = {
      nickname: '家长您好',
      head_portrait: '/static/A/images/portrait_1b42905.png'
    };
        ...
        webservice.getUserInfoMoreRow().then(function (res) {
          ...
          if (globals.STATUS_OK === status) {
            ...
            if ($scope.userInfo.head_portrait) {
              ...
              $scope.head_portrait = '/static/A/images/portrait_1b42905.png';
            }
          } else {
