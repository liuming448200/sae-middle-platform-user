define('A:widget/main/main', function(require, exports, module) {
  ...
  angular.module('eduApp').constant('globals', {
    ...
    POST: 'post',
    HEAD_IMAGE: 'head',
    LOGO_IMAGE: location.origin + '/static/A/images/logo_a0d82f8.jpg',
  ...
  require('A:widget/router/router');
  require('A:widget/config/config');
  require('A:widget/UAdetect/UAdetect');
  require('A:widget/baseAuth/baseAuth');
  require('A:widget/webservice/webservice');
  require('A:widget/shareService/shareService');
